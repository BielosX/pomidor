...
func (in *NetworkLoadBalancerSpec) DeepCopyInto(out *NetworkLoadBalancerSpec) {
	*out = *in
	...
	if in.SecurityGroupIngress != nil {
		in, out := &in.SecurityGroupIngress, &out.SecurityGroupIngress
		*out = make([]SecurityGroupIngressSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NetworkLoadBalancerStatus) DeepCopyInto(out *NetworkLoadBalancerStatus) {
	*out = *in
	...
	if in.ClusterSgRuleId != nil {
		in, out := &in.ClusterSgRuleId, &out.ClusterSgRuleId
		*out = new(string)
		**out = **in
	}
